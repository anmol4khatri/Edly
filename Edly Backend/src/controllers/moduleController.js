...
export const createModule = async (req, res) => {
	...
	const newModule = await moduleService.createModule(req.tenant._id, req.user.role, courseId, req.body);
...
export const addContent = async (req, res) => {
	...
	const updatedModule = await moduleService.addContent(req.tenant._id, req.user.role, courseId, moduleId, content);
...
export const deleteContent = async (req, res) => {
	...
	const updatedModule = await moduleService.deleteContent(req.tenant._id, req.user.role, moduleId, type, refId);
