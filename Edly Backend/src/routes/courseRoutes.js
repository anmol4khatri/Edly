...
router.get(
  ...
  asyncHandler(moduleController.getAllModulesByCourse)
);
router.post(
  '/:courseId/modules',
  asyncHandler(requireAuth),
...
router.post(
  ...
  asyncHandler(requireAuth),
  asyncHandler(moduleController.addContent)
);
router.delete(
  '/:courseId/modules/:moduleId/content/:type/:refId',
  asyncHandler(requireAuth),
  asyncHandler(moduleController.deleteContent)
);
