...
const ContinueWatching = () => {
  return (
    <div className="min-h-screen bg-background container-padding section-padding flex gap-6 max-sm:flex-col">
      <div className="w-6/10 max-sm:w-full">
        ...
        ></video>
        <p className="heading-1 mt-component">Docker and Kubernates</p>
      </div>
