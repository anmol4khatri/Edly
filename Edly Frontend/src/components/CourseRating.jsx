              ...
              <div className="mb-6 space-y-2 min-sm:w-2xl">
                {reviewData.map((item) => (
                  <div key={item.stars} className="flex items-center gap-4">
                    <div className="text-slate-300 font-medium w-16 text-left">
                      {item.stars} stars
                    </div>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="flex flex-col gap-0 p-0 [&>button:last-child]:top-3.5 bg-[#17181C] border-black border-2 text-white">
                <DialogHeader className="contents space-y-0 text-left">
                  <DialogTitle className="border-b border-slate-600 px-6 py-4 text-base text-white">
                    Write a Review
                  </DialogTitle>
                </DialogHeader>
                  ...
                  <form className="space-y-5">
                    ...
                    <div className="flex justify-end gap-3">
                      <Button
                        ...
                        className="px-6 bg-transparent border-slate-600 text-slate-300 hover:bg-slate-700 hover:text-white"
                      >
                        Cancel
                      </Button>
                      <Button
