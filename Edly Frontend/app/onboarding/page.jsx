          ...
          <a href="#" className="flex items-center gap-2 font-medium">
            <div
              ...
              <svg
                ...
                <path
                  d="M19 8.5V10h1.5A1.5 1.5 0 0 1 22 11.5v1A1.5 1.5 0 0 1 20.5 14H19v1.5a1.5 1.5 0 0 1-1.5 1.5H16" />
                <rect width="3" height="8" x="8" y="14" rx="1.5" />
                <path
                  d="M5 15.5V14H3.5A1.5 1.5 0 0 1 2 12.5v-1A1.5 1.5 0 0 1 3.5 10H5V8.5A1.5 1.5 0 0 1 6.5 7H8" />
              </svg>
            </div>
            Acme Inc.
          </a>
